...
def github_create_repo() -> None:
    body_json = {"name": "tantalum", "description": "placeholder"}
...
def github_create_secret(secret_name: str, secret_value: str) -> None:
    url_public_key = (
        ...
        "/tantalum/actions/secrets/public-key"
    )
    ...
    if r.status_code == 200:
        ...
        url_secret = (
            ...
            f"Stephen-RA-King"
            f"/tantalum/actions/secrets/{secret_name}"
        )
...
def readthedocs_update() -> None:
    body_json = {"name": "tantalum", "default_branch": "main"}
...
def main() -> None:
    ...
    file_path = r"\tantalum\Lib\site-packages\semantic_release\repository.py"
